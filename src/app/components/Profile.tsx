  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed top-4 left-4 md:top-8 md:left-8 z-40 flex items-center gap-2 px-4 py-2 bg-cyan-950/50 hover:bg-cyan-900/80 text-cyan-200 rounded-lg transition-colors backdrop-blur-sm border border-cyan-500/30"
      >
        <ChevronLeft size={20} />
        Back
      </motion.button>
      ...
      <motion.div
        ...
        className="my-auto bg-[#0b1026]/75 rounded-2xl p-5 md:p-8 max-w-2xl w-full shadow-2xl border border-cyan-500/30 hover:border-cyan-400/50 backdrop-blur-md transition-all duration-300"
      >
        <motion.div
