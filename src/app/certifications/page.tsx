        ...
        <div className="mb-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {certificates.map((cert) => (
              <div
                key={cert.id}
                className="border border-white/[0.06] rounded-2xl p-6 hover:border-white/15 transition-all duration-300"
              >
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            {patents.map((patent) => (
              <div
                key={patent.id}
                className="border border-white/[0.06] rounded-2xl p-6 sm:p-7 hover:border-white/15 transition-all duration-300"
              >
