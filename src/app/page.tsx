...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="min-h-[90vh] flex flex-col justify-center px-6 sm:px-8 max-w-6xl mx-auto">
        <div className="max-w-2xl">
          <p className="text-[11px] tracking-[0.35em] uppercase text-neutral-600 mb-8">
            Full Stack Developer
          </p>
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tighter leading-[0.95] mb-8">
            Vashu
            <br />
            Gupta
          </h1>
      ...
      {/* Featured Work */}
      <section className="px-6 sm:px-8 max-w-6xl mx-auto pb-24 sm:pb-32">
        <div className="border-t border-white/[0.06] pt-16 sm:pt-20">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {projects.slice(0, 4).map((project) => (
              <div
                key={project.id}
                className="group border border-white/[0.06] rounded-2xl p-5 sm:p-6 hover:border-white/15 transition-all duration-300"
              >
