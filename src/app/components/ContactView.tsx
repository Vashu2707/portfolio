  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed top-4 left-4 md:top-8 md:left-8 z-40 flex items-center gap-2 px-4 py-2 bg-rose-950/50 hover:bg-rose-900/80 text-rose-200 rounded-lg transition-colors backdrop-blur-sm border border-rose-500/30"
      >
        <ChevronLeft size={20} />
        Back
      </motion.button>
